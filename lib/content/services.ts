...
export const services: Service[] = [
  ...
  },
  {
    ...
    headline: "Custom Software, Mobile Apps, SaaS, Fintech & AI Solutions",
    summary:
      "We define, design, build, deploy, and support web, mobile, SaaS, fintech, insurance, and AI-enabled applications.",
    icon: "code",
    capabilities: [
      "Web applications",
      "Mobile applications",
    ...
    services: [
      ...
      "Insurance quoting, policy, and claims workflows",
  ...
  },
  {
    ...
    services: [
      ...
      "Credit, underwriting & claims analytics",
  ...
  },
  {
    ...
    services: [
      ...
      "Secure SDLC",
      "Secrets management",
      "Compliance readiness (SOC 2, PCI DSS, HIPAA, GDPR)",
      "Financial services & insurance regulatory controls",
      "Audit logging & evidence automation",
      "Security monitoring",
      "Policy automation",
      "Risk assessment",
    ],
